...
const { requireServiceAuth, verifyServiceBearer } = require(
  path.join(__dirname, "..", "..", "tethro-auth-shared", "index.js")
);
...
function handleProxy(req, res) {
  ...
  // ─── Revoke session key (by sessionKey and/or sessionId) ───
